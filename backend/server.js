...
const Guradian_tab_url2 = "?api-key=e628090b-804b-44f6-8a69-f33efc0bdf06&show-blocks=all";

const NYTime_home_url = "https://api.nytimes.com/svc/topstories/v2/home.json?api-key=DIf8BxjjPBV4d7BhKfIQuisngHYrb1ti";
const NYTime_tab_url1 = "https://api.nytimes.com/svc/topstories/v2/";
const NYTime_tab_url2 = ".json?api-key=DIf8BxjjPBV4d7BhKfIQuisngHYrb1ti";
...
app.get("/api/Search", function (req, res) {
    ...
    if (params.source == 'G') {
        cur_url = 'https://content.guardianapis.com/search?q=' + params.keyword + '&api-key=e628090b-804b-44f6-8a69-f33efc0bdf06&show-blocks=all'
    }
    else if (params.source == 'N') {
        cur_url = 'https://api.nytimes.com/svc/search/v2/articlesearch.json?q=' + params.keyword + '&api-key=DIf8BxjjPBV4d7BhKfIQuisngHYrb1ti'
    }
    //console.log("Search")
...
app.get("/api/Detail", function (req, res) {
    ...
    var params = url.parse(req.url, true).query;
    if (params.source == 'G') {
        cur_url = "https://content.guardianapis.com/" + params.link + "?api-key=e628090b-804b-44f6-8a69-f33efc0bdf06&show-blocks=all";
    }
    else {
        cur_url = "https://api.nytimes.com/svc/search/v2/articlesearch.json?fq=web_url:(%22" + params.link + "%22)&api-key=DIf8BxjjPBV4d7BhKfIQuisngHYrb1ti";
    }
    //console.log("Detail")
